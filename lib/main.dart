...
void main() {
  runApp(const HasiriApp());
}

class HasiriApp extends StatelessWidget {
  const HasiriApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'HASIRI - AgriAssistant',
      theme: HasiriTheme.lightTheme,
      home: LoginPage(), // Back to original login page
      debugShowCheckedModeBanner: false,
    );
  }
}

// New Market Price Trend Analysis Page
